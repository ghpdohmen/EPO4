...
class challengesSubSystem(subSystem):
    ...
    def challengeA(self):
        ...
        match self.stateA:
            ...
            case 3:
                ...
                if mathFunctions.ish(robot.Robot.posXLocalization * 100, self.ch_aEnd[0],
                                     150) == True and mathFunctions.ish(
    ...
    def challengeB(self):
        ...
        match self.stateB:
            ...
            case 3:
                # if we are withing 150cm of our waypoi nt, slow down
                if mathFunctions.ish(robot.Robot.posXLocalization * 100, self.ch_bMid[0],
                                     150) == True and mathFunctions.ish(
            ...
            case 4:
                ...
                if mathFunctions.ish(robot.Robot.posXLocalization * 100, self.ch_bMid[0],
                                     100) == True and mathFunctions.ish(
            ...
            case 7:
                ...
                robot.Robot.startPos = [robot.Robot.posXLocalization * 100,
                                        robot.Robot.posYLocalization * 100]  # sets new destination positions for second stint
            ...
            case 9:
                ...
                if mathFunctions.ish(robot.Robot.posXLocalization * 100, self.ch_bEnd[0],
                                     150) == True and mathFunctions.ish(
